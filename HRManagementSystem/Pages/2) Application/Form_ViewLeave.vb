...
Public Class Form_ViewLeave
    ...
    Public Sub New(fullInformation As viewFullInformation, Optional dgvName As String = "")
        ...
        If Not dgvName.Contains("dgv_Leave") AndAlso Not dgvName.Contains("dgNotif") Then
    ...
    Private Sub DatagridProperties()
        ...
        With dgvInformation
            ...
            .Columns("RequestType").HeaderText = "Type of Leave"

            .Columns("StartDate").HeaderText = "Start Date"
            .Columns("StartDate").DefaultCellStyle.Format = "MMMM dd, yyyy"

            .Columns("EndDate").HeaderText = "End Date"
            .Columns("EndDate").DefaultCellStyle.Format = "MMMM dd, yyyy"

            .Columns("NoOfDays").HeaderText = "No. of Days"

            .Columns("LeaveDescription").HeaderText = "Description"
        End With
    ...
    Private Async Sub btnApprove_Click(sender As Object, e As EventArgs) Handles btnApprove.Click
        ...
        With _fullInformation
            ...
            Dim notifSubject As String = If(.Application.isCancelled,
                                            "BUS: Leave Cancellation Notification - Application ID# " & ApplicationID,
                                            "BUS: Leave Notification - Application ID# " & ApplicationID)

            Dim notifBody As String = If(.Application.isCancelled,
                                            "Cancellation of your leave has been approved.",
    ...
    Private Async Sub btnReject_Click(sender As Object, e As EventArgs) Handles btnReject.Click
        ...
        With _fullInformation
            ...
            Dim notifBody As String = If(.Application.isCancelled,
                                            "Cancellation of your leave has been rejected.",
