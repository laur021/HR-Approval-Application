...
Public Class Form_ViewChangeShift
    ...
    Public Sub New(fullInformation As viewFullInformation, Optional dgvName As String = "")
        ...
        With _fullInformation
            ...
            If .Comment IsNot Nothing AndAlso .Comment.Any() Then
                With dgComments
                    .DataSource = _fullInformation.Comment.OrderBy(Function(x) x.AddedDate).ToList()
                    .AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill
                    .DefaultCellStyle.WrapMode = DataGridViewTriState.True
                    .AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.AllCells
                    .RowsDefaultCellStyle.Padding = New Padding(0, 20, 0, 20)
                    ...
                    .Columns("Commentor").Visible = True
                    .Columns("Commentor").DefaultCellStyle.Alignment = DataGridViewContentAlignment.TopLeft
                    .Columns("Commentor").FillWeight = 150

                    .Columns("Comment").Visible = True
                    .Columns("Comment").DefaultCellStyle.Alignment = DataGridViewContentAlignment.TopLeft
                    .Columns("Comment").FillWeight = 300

                    .Columns("Status").Visible = True
                    .Columns("Status").DefaultCellStyle.Alignment = DataGridViewContentAlignment.TopLeft
                    .Columns("Status").FillWeight = 120

                    .Columns("AddedDate").Visible = True
                    .Columns("AddedDate").DefaultCellStyle.Alignment = DataGridViewContentAlignment.TopRight
                    .Columns("AddedDate").FillWeight = 135
                End With
            End If
        ...
        If Not dgvName.Contains("dgv_ChangeShift") AndAlso Not dgvName.Contains("dgNotif") Then
    ...
    Private Sub DatagridProperties()
        ...
        With dgvInformation
            ...
            .Columns("NewSchedule").Visible = True
            .Columns("NewSchedule").HeaderText = "New Schedule"
    ...
    Private Async Sub btnApprove_Click(sender As Object, e As EventArgs) Handles btnApprove.Click
        ...
        With _fullInformation
            ...
            Dim notifSubject As String = If(.Application.isCancelled,
                                            "BUS: Change Shift Cancellation Notification - Application ID# " & ApplicationID,
                                            "BUS: Change Shift Notification - Application ID# " & ApplicationID)

            Dim notifBody As String = If(.Application.isCancelled,
                                            "Cancellation of your change shift has been approved.",
                                            "Your change shift application has been approved.")
    ...
    Private Async Sub btnReject_Click(sender As Object, e As EventArgs) Handles btnReject.Click
        ...
        With _fullInformation
            ...
            Dim notifBody As String = If(.Application.isCancelled,
                                            "Cancellation of your change shift has been rejected.",
                                            "Your change shift application has been rejected.")
