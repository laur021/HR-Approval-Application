...
Public Class Form_ViewOverTime
    ...
    Public Sub New(fullInformation As viewFullInformation, Optional dgvName As String = "")
        ...
        If Not dgvName.Contains("dgv_OverTime") AndAlso Not dgvName.Contains("dgNotif") Then
    ...
    Private Sub DatagridProperties()
        ...
        With dgvInformation
            ...
            .Columns("RequestType").HeaderText = "OT Type"

            .Columns("ShiftDate").Visible = True
            .Columns("ShiftDate").DefaultCellStyle.Format = "MMMM dd, yyyy"
            .Columns("ShiftDate").HeaderText = "Date"

            .Columns("StartTime").Visible = True
            .Columns("StartTime").HeaderText = "Start Time"
            .Columns("StartTime").DefaultCellStyle.Format = "hh:mm tt"

            .Columns("EndTime").Visible = True
            .Columns("EndTime").HeaderText = "End Time"
            .Columns("EndTime").DefaultCellStyle.Format = "hh:mm tt"

            .Columns("TotalHours").Visible = True
            .Columns("TotalHours").HeaderText = "Total No. of Hours"
    ...
    Private Async Sub btnApprove_Click(sender As Object, e As EventArgs) Handles btnApprove.Click
        ...
        With _fullInformation
            ...
            Dim notifSubject As String = If(.Application.isCancelled,
                                            "BUS: Overtime Cancellation Notification - Application ID# " & ApplicationID,
                                            "BUS: Overtime Notification - Application ID# " & ApplicationID)

            Dim notifBody As String = If(.Application.isCancelled,
                                            "Cancellation of your overtime application has been approved.",
                                            "Your overtime application has been approved.")
    ...
    Private Async Sub btnReject_Click(sender As Object, e As EventArgs) Handles btnReject.Click
        ...
        With _fullInformation
            ...
            Dim notifBody As String = If(.Application.isCancelled,
                                            "Cancellation of your overtime application has been rejected.",
                                            "Your overtime application has been rejected.")
